...
SUBSCRIBERS = ["rhona@grimes.info", "cedricschmidt@robel.io", "edmond@ko.org", 
"bryant@cummingsfisher.biz", "alverta@bernhard.name"]
...
def print_many_articles(articles)
  # Takes in an array of article hashes (ex. from first_n_articles) and formats each one using the print_one_article method
